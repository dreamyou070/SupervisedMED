...
def main():
    ...
    for lora_folder in lora_folders:
        ...
        thres = os.listdir(lora_dir)
        for thre in thres:
            thre_dir = os.path.join(lora_dir, thre)

            args.anomaly_maps_dir = os.path.join(thre_dir, 'scoring')

            args.output_dir = os.path.join(thre_dir, 'metrics')
