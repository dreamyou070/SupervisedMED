...
python ../data_check.py --log_with wandb \
 --output_dir "../../result/${category}/${obj_name}/${layer_name}/${sub_folder}/${file_name}/data_check_anomal_br_trg_beta_0.8_blur_2" \
 ...
 --anomal_source_path "../../../MyData/anomal_source_l_mode_neat_br" \
